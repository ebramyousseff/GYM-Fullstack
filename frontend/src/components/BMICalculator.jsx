...
const BMICalculator = () => {
  ...
  const calculateBMI = (e) =>{
    ...
    if(!height || !weight || !gender){
      TransformStream.error("Please enter valid height, weight and gender.");
      return;
    }
    ...
    if(bmiValue < 18.5){
      toast.warning(
        "You are underweight. Please consult a doctor for advice."
      );
    }
    ...
    toast.warning(
      "You are Overweight. Keep maintaing a healthy Lifestyle"
    )
  }
  else{
    toast.error(
